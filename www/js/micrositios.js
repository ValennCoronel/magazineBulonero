document.addEventListener("DOMContentLoaded", () => {
  ...
  if (id) {
    ...
    fetch("../micro-sitios/anunciantes.json?v=2.0") // Ajusta la ruta según sea necesario
      ...
      .then((data) => {
        ...
        if (data.anunciantes[id]) {
          ...
          // Contenido basico
          document.querySelector(".card-img-top").src = anunciante.logo || "default_logo.png";
          document.querySelector(".card-img-top").alt = anunciante.titulo + " Logo";
          document.querySelector(".titulo_ge").textContent = anunciante.titulo;
          document.querySelector(".titulo-marca").textContent = anunciante.titulo;
          ...
          /*-------------- REDES --------------*/
          //Web
          if(anunciante.social.web != null && anunciante.social.web.trim() !== ""){
          document.querySelector(".datos-web a").href = anunciante.social.web;
          document.querySelector(".datos-web a").title = anunciante.social.webtxt;
          ...
          //Instagram
          if(anunciante.social.instagram != null && anunciante.social.instagram.trim() !== ""){
            document.querySelector(".datos-ig a").href = anunciante.social.instagram;
            document.querySelector(".datos-ig a").textContent = anunciante.social.instagramName;
          }else{
        ...
        //Email
          if(anunciante.social.email != null && anunciante.social.email.trim() !== ""){
            document.querySelector(".datos-email a").href = anunciante.social.mailto;
            document.querySelector(".datos-email a").textContent = anunciante.social.email;
          }else{
        ...
        if(anunciante.social.facebook != null && anunciante.social.facebook.trim() !== ""){
            document.querySelector(".datos-facebook a").href = anunciante.social.facebook;
            document.querySelector(".datos-facebook a").textContent = anunciante.social.facebookName;
          }else{
            document.querySelector(".datos-facebook").style.display = 'none';
          }

        //Linkedin
        if(anunciante.social.linkedin != null && anunciante.social.linkedin.trim() !== ""){
            document.querySelector(".datos-linkedin a").href = anunciante.social.linkedin;
            document.querySelector(".datos-linkedin a").textContent = anunciante.social.linkedinName;
          }else{
            document.querySelector(".datos-linkedin").style.display = 'none';
          }

        //youtube
        if(anunciante.social.youtube != null && anunciante.social.youtube.trim() !== ""){
            document.querySelector(".datos-youtube a").href = anunciante.social.youtube;
            document.querySelector(".datos-youtube a").textContent = anunciante.social.youtubeName;
          }else{
          ...
          //Catalogo
          if(anunciante.catalogo != null && anunciante.catalogo.trim() !== ""){
            document.querySelector(".link-catalogo a").href = anunciante.catalogo;
          }else{
    ...
    document.body.innerHTML = "<h1>ID del parámetro no está presente en la URL</h1>";
